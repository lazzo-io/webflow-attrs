...
const input_number_btn_increase = document.querySelector(
  '[lazzo-input-number="increase"]'
);

const input_number_btn_decrease = document.querySelector(
  '[lazzo-input-number="decrease"]'
);
